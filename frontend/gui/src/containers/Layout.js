    ...
    return (
      <Layout className="layout">
        <Header>
          ...
          >
            <Menu.Item className="item1" key="1" onClick = {() => this.updatePage("Home")}><Link to="/">Talent Exchange</Link></Menu.Item>
            {
            this.props.isAuthenticated ?
            <Menu.Item className="item21" key="2" onClick = {this.props.logout} >Logout</Menu.Item>
            :
            ...
            <Menu.Item className="item7" key="7" onClick = {() => this.updatePage("profile")}><Link to="/profile/">Profile</Link></Menu.Item>
          </Menu>
        </Header>
